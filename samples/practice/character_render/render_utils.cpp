...
namespace RenderUtils {
    ...
    void GetSortedNodes(vkb::sg::Scene* scene, glm::vec3 direction, glm::vec3 position, SortedMeshes* opaque_nodes, SortedMeshes* transparent_nodes) {
        auto meshes = scene->get_components<vkb::sg::Mesh>();
