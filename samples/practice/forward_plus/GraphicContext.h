...
namespace GraphicContext
{
    ...
    extern std::shared_ptr<vkb::core::Image> sceneNormalImage;
    extern std::shared_ptr<vkb::core::Image> sceneParamsImage;
    extern std::shared_ptr<vkb::core::Image> shadowImage;
    extern std::shared_ptr<vkb::core::Image> linearDepthImage[2];       // TAA used : current/previous
    extern std::shared_ptr<vkb::core::Image> screenShadowImage;
    extern std::shared_ptr<vkb::core::Image> lumaResultImage;
    extern std::shared_ptr<vkb::core::Image> temporalBlendImage[2];     // TAA used
    ...
    extern std::shared_ptr<vkb::core::ImageView> sceneNormalImageView;
    extern std::shared_ptr<vkb::core::ImageView> sceneParamsImageView;
